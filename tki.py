...
def display_results(title, results):
    """Отображает результаты в отдельном окне."""
...
def main():
    ...
    tk.Button(root, text="Список всех компаний и количество вакансий у каждой компании", command=show_companies_and_vacancies_count).pack(fill=tk.X)
